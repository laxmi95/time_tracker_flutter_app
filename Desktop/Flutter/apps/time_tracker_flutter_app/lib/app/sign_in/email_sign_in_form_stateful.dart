...
class EmailSignInFormStateStateful extends StatefulWidget with EmailPasswordValidator {
  @override
  _EmailSignInFormStateStateful createState() => _EmailSignInFormStateStateful();
}

class _EmailSignInFormStateStateful extends State<EmailSignInFormStateStateful> {
